...
ffmpeg = "-map 0:v -map 0:a? -map 0:s:0? -c:v libx265 -pix_fmt yuv420p -x265-params 'no-info=1' -crf 30 -vf 'drawtext=fontfile=/path/to/font.ttf:fontsize=25:fontcolor=white:bordercolor=black@0.50:x=w-tw-10:y=10:box=1:boxcolor=black@0.5:boxborderw=6:text=@AnyLink_Movie' -s 1280x720 -preset medium -metadata title='@AnyLink_Movie'  -metadata:s:v title='@AnyLink_Movie - 720p - HEVC - 8bit'  -metadata:s:a title='[@AnyLink_Movie Audio] - AAC - 40k kbps' -metadata:s:s title='[@AnyLink_Movie Subs]' -c:a libfdk_aac -ab 50k -ac 2 -profile:a aac_he_v2 -c:s copy"
